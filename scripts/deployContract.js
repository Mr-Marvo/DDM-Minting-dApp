...
const BASE_URI = 'ipfs://QmbNHrYzf6uTwV11BVc5wdruLcvxExHZdqSETHLAWHP6oU/'
...
async function main() {
  ...
  // Deploy the contract
  const DidemRaffe = await hre.ethers.getContractFactory('PeaceEagle')
  ...
  console.log('PeaceEagle deployed to:', didemRaffe.address)
}
